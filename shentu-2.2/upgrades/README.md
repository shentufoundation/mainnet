...
1. Wait until upgrade height `29,367,500` is reached
2. Stop the running shentud daemon
3. Replace the running shentud binary with the v2.18.0 version
4. Restart the shentud daemon with the v2.18.0 version

You can find the release notes and built binaries here: https://github.com/shentufoundation/shentu/releases/tag/v2.18.0

# v2.17.0 upgrade

The upgrade is scheduled at block height [28,124,200](https://www.mintscan.io/shentu/block/28124200), approximately on `Feb 25th 2026, 13:00UTC`.

Here are what you need to do:

1. Wait until upgrade height `28,124,200` is reached
2. Stop the running shentud daemon
3. Replace the running shentud binary with the v2.17.0 version
4. Restart the shentud daemon with the v2.17.0 version

You can find the release notes and built binaries here: https://github.com/shentufoundation/shentu/releases/tag/v2.17.0


# v2.16.0 upgrade

The upgrade is scheduled at block height [26,267,300](https://www.mintscan.io/shentu/block/26267300), approximately on `Oct 24th 2025, 13:00UTC`.

Here are what you need to do:

1. Wait until upgrade height `26,267,300` is reached
2. Stop the running shentud daemon
3. Replace the running shentud binary with the v2.16.0 version
4. Restart the shentud daemon with the v2.16.0 version

You can find the release notes and built binaries here: https://github.com/shentufoundation/shentu/releases/tag/v2.16.0


# v2.15.0 upgrade

The upgrade is scheduled at block height [24,865,200](https://www.mintscan.io/shentu/block/24865200), approximately on `July 22nd 2025, 13:00 UTC`.
...
You can find the release notes and built binaries here: https://github.com/shentufoundation/shentu/releases/tag/v2.15.0

# v2.14.0 upgrade

The upgrade height is [22399700](https://www.mintscan.io/shentu/block/22399700), which is approx. `February 6nd 2025, 13:00 UTC`.
...
The upgrade at height [21239900](https://www.mintscan.io/shentu/block/21239900), expected around `Nov 19nd, 2024 13:00 UTC`.
...
An upgrade is planned for the Shentu mainnet at height `20949300`, which is estimated to be reached around 12:30PM UTC on Oct 30nd, 2024.
